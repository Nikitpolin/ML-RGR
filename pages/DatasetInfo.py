...
st.write("- hazardous: является ли астероид потенциально опасным или нет")
st.header("Особенности предобработки данных")
st.write("В датасете необходимо предугадывать был ли является ли астероид потенциально опасным или нет. Опасность опеределяется показателем 1 или 0.")
...
st.write("Числовые признаки были масштабированы. Дисбаланс был устраннен алгоритмом NearMiss")